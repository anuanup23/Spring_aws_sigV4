...
public class S3FileUploader {
    ...
    private static final String BUCKET_NAME = "my-sigv4-example-bucket-west";
    private static final String FILE_KEY = "hello1.txt";
    private static final String FILE_CONTENT = "Hello, World! This file was uploaded using SigV4 authentication.";
    ...
    private static void uploadFile() throws Exception {
        ...
        String contentSha256 = calculateSHA256Hash(FILE_CONTENT);
        ...
        SdkHttpFullRequest.Builder requestBuilder = SdkHttpFullRequest.builder()
                ...
                .encodedPath("/" + BUCKET_NAME + "/" + FILE_KEY)
                ...
                .putHeader("x-amz-storage-class", "STANDARD");

        // Add the request body
        requestBuilder.contentStreamProvider(() -> 
            new java.io.ByteArrayInputStream(FILE_CONTENT.getBytes(StandardCharsets.UTF_8)));
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            // Add the request body
            httpPut.setEntity(new StringEntity(FILE_CONTENT));

            // Execute the request
            org.apache.http.HttpResponse response = httpClient.execute(httpPut);
            HttpEntity entity = response.getEntity();
            
            System.out.println("Uploading file: " + FILE_KEY);
